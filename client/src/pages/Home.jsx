    ...
    <div className="bg-gray-50">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Custom tattoo designs tailored to your vision with the highest quality standards.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {[
          ...
          <div 
            key={index} 
            className={`${service.bgClass} group p-8 rounded-xl border border-gray-200 hover:border-red-300 transition-all duration-300 shadow-sm hover:shadow-md`}
          >
            <div className="flex items-center mb-6">
              <div className="p-2 rounded-lg bg-red-600 text-white mr-4 group-hover:bg-black transition-colors">
                {service.icon}
              </div>
            ...
            <a 
              href="/booking" 
              className="inline-flex items-center text-red-600 hover:text-black font-medium transition-colors"
            >
              Learn more
          ...
          <div className="md:flex items-center gap-12">
            ...
            <div className="md:w-1/2">
              ...
              <p className="text-lg mb-6 text-gray-300">
                With over 40 years of experience in fine art and tattooing.
              </p>
